...
This has also been tested successfully with GPX exports from **Komoot** and **Detecht**. Please feel free to contact me if you want to try other route planners' output (or let me know if you found it worked with others, and I'll create/update a compatibility list).
